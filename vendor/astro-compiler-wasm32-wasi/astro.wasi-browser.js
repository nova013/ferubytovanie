...
const __wasmUrl = new URL('./astro.wasm32-wasi.wasm', import.meta.url).href
...
const {
  ...
  wasi: __wasi,
  onCreateWorker() {
    const worker = new Worker(new URL('@astrojs/compiler-binding-wasm32-wasi/wasi-worker-browser.mjs', import.meta.url), {
      type: 'module',
    })
